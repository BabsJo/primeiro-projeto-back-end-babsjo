...
const router = express.Router() //aqui estou configurando a pimeira parte da rota

const cors = require('cors') // aqui estou trazendo o pacote cors q permite consumir essa API no front-end
